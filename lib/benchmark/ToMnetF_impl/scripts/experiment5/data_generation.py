...
Modified for experiment5 with random positions and goal rewards support
"""
...
class DataProcessor:
    ...
    def __init__(self, time_step, w, h, d, max_n_past=10):
        ...
        self.MAX_N_PAST = max_n_past  # Maximum number of past episodes
...
def generate_input_data(
    ...
    """
    Generate processed input data for ToMnet training with N_past support
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Generate processed input data for ToMnet training with N_past support"
    )
    parser.add_argument(
        "--data_dir",
        type=str,
        default="../data/experiment5",
