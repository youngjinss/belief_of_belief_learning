...
"""
Publication-quality visualization for ToMnetF (Experiment 5)
...
def create_summary_report(
    experiment_no,
    result_dir="../../result/experiment5",
    plot_dir="../../plots/experiment5",
    model=None,
    val_loader=None,
    device=None,
    has_n_past=False,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--result_dir",
        type=str,
        default="../../result/experiment5",
        help="Results directory",
    )
    parser.add_argument(
        "--plot_dir",
        type=str,
        default="../../plots/experiment5",
