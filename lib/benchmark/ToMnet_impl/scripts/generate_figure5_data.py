...
def main():
    parser = argparse.ArgumentParser(description='Generate Figure 5 data with goal-directed agents')
    ...
    parser.add_argument('--max_past', type=int, default=10, help='Maximum past episodes')
    ...
    save_path = os.path.join(args.output_dir, f"{args.experiment_name}_training_data.pkl")
