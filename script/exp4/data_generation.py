...
class DataReader:
    def __init__(self, time_step=500, w=9, h=9, d=9, experiment_no=4):
        """
        ...
        Args:
            ...
            experiment_no: Experiment number (4 for KeyDoor)
        """
...
if __name__ == "__main__":
    ...
    if args.visualize:
        save_path = os.path.join(args.output_dir, "exp4_data_statistics.png")
