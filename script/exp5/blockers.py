...
# from inside script/exp5/. Unnecessary once the project is installed.
import os as _os
import sys as _sys
...
# These three are AST-identical to the core versions, so they live there now and
# are re-exported here to keep `from blockers import ...` working.
from beliefrl.agents.blocker.goaldirected import GoalDirectAgent
from beliefrl.agents.blocker.random import RandomAgent
from beliefrl.agents.blocker.randomlyselect import RandomlySelectedAgent
