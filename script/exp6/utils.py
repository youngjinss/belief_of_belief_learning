"""
Common utility functions for exp6 scripts
...
# from inside script/exp6/. Unnecessary once the project is installed.
import os as _os
import sys as _sys
...
# Moved into the shared core; re-exported so `from utils import ...` keeps working.
...
def generate_past_episodes_from_batch(
    ...
    (Adapted from experiment 5 for exp6 multi-agent tensor format)
