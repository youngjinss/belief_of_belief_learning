...
class Config(BaseConfig):
    def __init__(self):
        ...
        self.model_dir = "results/exp7"
        self.test_data_dir = (
            None  # Will be set dynamically using get_data_path(is_test=True)
        )
        self.result_dir = "results/exp7"
        self.plot_dir = "results/exp7/plots"
        self.log_dir = "log/exp7"
