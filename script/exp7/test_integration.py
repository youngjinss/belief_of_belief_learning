...
from script.exp7.config import Config
...
def test_generate_command():
    ...
    print("  python script/exp7/generate.py --config_override --blocker_type none")
    print()
    
    print("Multi-agent mode (AchieverBlocker environment):")
    print("  python script/exp7/generate.py")
    print()
    
    print("Generate test data:")
    print("  python script/exp7/generate.py --test_data")
    print()
