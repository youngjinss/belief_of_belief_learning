...
from script.exp8.blockers import (
...
def run_single_game(game_id, config_dict, save_dir, blocker_type=None):
    ...
    # Get environment version and observability settings
    env_version = config_dict.get("env_version", 1)
    observability = config_dict.get("observability", "full")
    partial_view_sizes = config_dict.get("partial_view_sizes", {"5x5": 5, "9x9": 7, "11x11": 7})
    partial_view_size = partial_view_sizes.get(env_size, 7)
...
def generate_trajectories_for_combination(
    ...
    config_dict = {
        ...
        "partial_view_sizes": config.partial_view_sizes,
        "achiever_type": achiever_type,
